...
Migration `0001_initial_schema` creates the `aggregator` schema. Migration `0002_processing_core` adds processing leases, stable job-board identity, normalized fuzzy-match helpers, and processing-run review fields.
